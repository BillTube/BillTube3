...
/*! BillTube Framework (BTFW) compat loader — patched mods list (v2.7) */
(function(){
  ...
  }).then(function(){ console.log("[BTFW v2.7] Ready."); })
    .catch(function(e){ console.error("[BTFW v2.7] boot failed:", e&&e.message||e); });
})();
