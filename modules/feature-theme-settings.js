...
BTFW.define("feature:themeSettings", ["feature:layout"], async () => {
    ...
    m.innerHTML=`
      ...
      <div class="btfw-modal__card">
        <div class="btfw-modal__header">
          <h3 style="margin:0;font-weight:700">Theme Settings</h3>
  ...
  document.addEventListener("btfw:openThemeSettings", ()=>{ ensure(); document.querySelector("#btfw-theme-modal").classList.remove("hidden"); });
