BTFW.define("feature:channelThemeAdmin", [], async () => {
  ...
  function renderGradientLayer(theme, strengthScale = 1){
    ...
    if (gradient.type === "flow") {
      ...
      const shapes = `<ellipse class="flow-field flow-3" cx="855" cy="345" rx="655" ry="510" fill="${stops[3].color}"/><ellipse class="flow-field flow-2" cx="1080" cy="550" rx="735" ry="520" fill="${stops[2].color}"/><path class="flow-field flow-1" d="M-240 130C170 80 565 175 830 385C705 540 575 720 360 900H-240Z" fill="${stops[1].color}"/><path class="flow-field flow-0" d="M-220-160H1420V25C1110 10 865 110 705 305C460 220 175 185-220 225Z" fill="${stops[0].color}"/>`;
