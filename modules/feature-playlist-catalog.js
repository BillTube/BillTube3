...
BTFW.define("feature:playlistCatalog", [], async () => {
  ...
  function injectStyles(){
    ...
    style.textContent = `
      ...
      #btfw-playlist-catalogue .btfw-catalogue__dialog { width:min(1180px,100%); max-height:min(860px,94vh); overflow:hidden; display:flex; flex-direction:column; border:1px solid color-mix(in srgb,var(--btfw-color-accent) 35%,#fff 8%); border-radius:18px; background-color:var(--btfw-color-surface); background-image:var(--btfw-panel-gradient-soft); background-size:var(--btfw-panel-background-size); background-position:var(--btfw-panel-background-position); color:var(--btfw-color-text); box-shadow:0 22px 70px rgba(0,0,0,.55); transform:translateY(10px) scale(.98); transition:transform var(--btfw-motion-fast,150ms) var(--btfw-ease-out,ease-out); }
      ...
      #btfw-playlist-catalogue [data-action="close"] { border:0; border-radius:12px; padding:0 4px; background:transparent; color:color-mix(in srgb,var(--btfw-color-text,#eef2ff) 70%,transparent); font-size:18px; line-height:1; transition:color .14s ease; }
      #btfw-playlist-catalogue [data-action="close"]:hover { background:transparent; color:var(--btfw-color-accent); }
      #btfw-playlist-catalogue [data-action="close"]:focus-visible { outline:2px solid color-mix(in srgb,var(--btfw-color-accent) 68%,transparent); outline-offset:1px; }
      ...
      #btfw-playlist-catalogue select { appearance:none; cursor:pointer; padding-right:38px; color:var(--btfw-color-text,#eef2ff); background-color:color-mix(in srgb,var(--btfw-color-panel,#171d2b) 84%,transparent); background-image:linear-gradient(45deg,transparent 50%,var(--btfw-color-accent) 50%),linear-gradient(135deg,var(--btfw-color-accent) 50%,transparent 50%); background-position:calc(100% - 17px) 16px,calc(100% - 12px) 16px; background-size:5px 5px,5px 5px; background-repeat:no-repeat; }
      #btfw-playlist-catalogue select option, #btfw-playlist-catalogue select optgroup { color:var(--btfw-color-text,#eef2ff) !important; background-color:var(--btfw-color-surface,#11151e) !important; }
