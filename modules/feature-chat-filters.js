...
const customFilters = [
  ...
  { name: "sticker 7tv", source: "\\[7tv\\]([A-Za-z0-9]+)\\[\\/7tv\\]", flags: "gi", replace: "<img class=\"btfw-sticker\" src=\"https://cdn.7tv.app/emote/\\1/2x.webp\" style=\"height:2.2em !important;width:auto !important;max-height:2.2em !important;vertical-align:middle;display:inline-block\" />", active: true, filterlinks: false },
  { name: "sticker bttv", source: "\\[bttv\\]([A-Za-z0-9]+)\\[\\/bttv\\]", flags: "gi", replace: "<img class=\"btfw-sticker\" src=\"https://cdn.betterttv.net/emote/\\1/2x.webp\" style=\"height:2.2em !important;width:auto !important;max-height:2.2em !important;vertical-align:middle;display:inline-block\" />", active: true, filterlinks: false },
  { name: "sticker ffz", source: "\\[ffz\\]([0-9]+)\\[\\/ffz\\]", flags: "gi", replace: "<img class=\"btfw-sticker\" src=\"https://cdn.frankerfacez.com/emote/\\1/2\" style=\"height:2.2em !important;width:auto !important;max-height:2.2em !important;vertical-align:middle;display:inline-block\" />", active: true, filterlinks: false },
  { name: "sticker egg", source: "\\[egg\\]([A-Za-z0-9_.-]+)\\[\\/egg\\]", flags: "gi", replace: "<img class=\"btfw-sticker\" src=\"https://cdn3.emoji.gg/emojis/\\1\" style=\"height:2.2em !important;width:auto !important;max-height:2.2em !important;vertical-align:middle;display:inline-block\" />", active: true, filterlinks: false },
  // Animated emoji (Google Noto Animated Emoji, Apache-2.0) — the Emoji tab
  // inserts [ae]<codepoint>[/ae]; rendered a touch smaller than stickers.
  { name: "animated emoji", source: "\\[ae\\]([0-9a-f_]+)\\[\\/ae\\]", flags: "gi", replace: "<img class=\"btfw-sticker btfw-aemoji\" src=\"https://fonts.gstatic.com/s/e/notoemoji/latest/\\1/512.webp\" style=\"height:1.8em !important;width:auto !important;max-height:1.8em !important;vertical-align:middle;display:inline-block\" />", active: true, filterlinks: false },
